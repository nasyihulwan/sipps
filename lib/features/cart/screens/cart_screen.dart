...
import 'package:sipps/features/cart/widgets/cart_product.dart';
import 'package:sipps/features/cart/widgets/cart_subtotal.dart';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: CustomButton(
                text: 'Lanjutkan untuk membeli (${user.cart.length} item)',
